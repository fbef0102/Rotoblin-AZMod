...
public void OnPluginStart()
{
	...
	g_hCvarRandomise =	CreateConVar(	"l4d_weapon_spawn_randomise",		"0",			"0=Off. Chance out of 100 to randomise the type of item/weapon regardless of what it's set to.", CVAR_FLAGS );
