...
public OnPluginStart() {
    ...
    cvar_bashKillHunter = CreateConVar("l4d_hunter_no_bash_kills", "1", "Prevent hunter from getting bashed to death", FCVAR_NOTIFY);
    cvar_bashKillSmoker = CreateConVar("l4d_smoker_no_bash_kills", "1", "Prevent smoker from getting bashed to death", FCVAR_NOTIFY);
    cvar_bashKillBoomer = CreateConVar("l4d_boomer_no_bash_kills", "0", "Prevent boomerfrom getting bashed to death", FCVAR_NOTIFY);
