...
public OnPluginStart()
{
	...
	h_AfkKickEnabled = CreateConVar("l4d_specafk_kickenabled", "0", "If kick enabled on afk while on spec", FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY, false, 0.0, false, 0.0);
