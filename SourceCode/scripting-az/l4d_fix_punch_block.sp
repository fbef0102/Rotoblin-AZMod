...
public Action CH_PassFilter(int touch, int pass, bool &result)
{
	...
	if (L4D_IsEngineLeft4Dead1() && GetEntProp(pass, Prop_Send, "m_zombieClass") != L4D1_ZOMBIE_CLASS_TANK)
		return Plugin_Continue;

	if (L4D_IsEngineLeft4Dead2() && GetEntProp(pass, Prop_Send, "m_zombieClass") != L4D2_ZOMBIE_CLASS_TANK)
		return Plugin_Continue;
