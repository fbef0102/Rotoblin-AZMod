...
public OnPluginStart()
{
	...
	hMinPounceAnnounce = CreateConVar("pounceannounce_minimum","15","The minimum amount of damage required to announce the pounce", FCVAR_NOTIFY);
	hShowDistance = CreateConVar("pounceannounce_showdistance","5","Show the distance the hunter traveled for the pounce.",FCVAR_NOTIFY);
