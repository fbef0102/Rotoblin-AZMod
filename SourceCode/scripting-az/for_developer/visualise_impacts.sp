...
public Plugin myinfo =
{
	...
	author = "A1m`, Harry",
	version = "1.7h-2026/9/23",
	description = "Shows the acutal bullet impacts (based on the original by Jahze, fully rewritten and improved) ",
...
void RemoveAllDecals(int iClient)
{
	...
	PrintToChat(iClient, "[Note] Use command `r_cleardecals` for client to clean old decals.");
}
