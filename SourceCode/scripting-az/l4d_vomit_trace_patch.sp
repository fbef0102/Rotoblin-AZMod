...
// 1. Pass through their teammates (ghosts as well).
// 2. Pass through some chain-link fences
// 3. Pass through incapacitated survivors who have already been vomited on.
