...
public void OnPluginStart()
{
	...
	g_hCvarDefault =		CreateConVar(	"l4d_flashlight_default",		"1",			"Turn on the light when players join. 0=Off. 1=Survivors. 2=Special Infected. 4=Survivor Bots. 8=Spectator. Add numbers together.", CVAR_FLAGS );
