...
{
	g_hCvarAllow =	CreateConVar("l4d_block_player_swim_allow",	"1", "0=Plugin off, 1=Plugin on.", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	g_bCvarAllow = g_hCvarAllow.BoolValue;
	g_hCvarAllow.AddChangeHook(ConVarChanged_Allow);

	AutoExecConfig(true, "l4d_block_player_swim");
}
