...
public OnPluginStart()
{
	...
	new Handle:hCvarEngineFlags = CreateConVar("engine_fix_flags", "12", "Enables what kind of exploit should be fixed/blocked. Flags (add together): 0=disable, 2=ladder speed glitch, 4=no fall damage bug, 8=health boost glitch.", FCVAR_PLUGIN, true, 0.0, true, 14.0);
