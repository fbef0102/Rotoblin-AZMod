...
public OnPluginStart()
{
	...
	g_hCvarValidateAuth = SMAC_CreateConVar("smac_validate_auth", "1", "Kick clients that fail to authenticate within 15 seconds of joining the server.", 0, true, 0.0, true, 1.0);
...
public OnClientPutInServer(client)
{
	...
	{
		CreateTimer(15.0, Timer_ValidateAuth, GetClientSerial(client), TIMER_FLAG_NO_MAPCHANGE);
	}
}
