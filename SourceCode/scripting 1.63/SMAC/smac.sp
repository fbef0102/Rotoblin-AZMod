...
/* Globals */
#define UPDATE_URL	"http://smac.sx/updater/smac.txt"
...
public OnPluginStart()
{
	...
	g_hCvarWelcomeMsg = CreateConVar("smac_welcomemsg", "1", "Display a message saying that your server is protected.", 0, true, 0.0, true, 1.0);
	g_hCvarBanDuration = CreateConVar("smac_ban_duration", "1440", "The duration in minutes used for automatic bans. (0 = Permanent)", 0, true, 0.0);
	g_hCvarLogVerbose = CreateConVar("smac_log_verbose", "1", "Include extra information about a client being logged.", 0, true, 0.0, true, 1.0);
